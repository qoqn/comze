...
describe('fetchPackage', () => {
    ...
    test('returns package info for valid package', async () => {
        const mockResponse = {
            packages: {
                'vendor/package': [
                    { version: '2.0.0', version_normalized: '2.0.0.0', time: '2024-01-01T12:00:00+00:00' },
                    { version: '1.0.0', version_normalized: '1.0.0.0', time: '2023-01-01T12:00:00+00:00' },
                ],
            },
        };
    ...
    test('skips dev versions and returns latest stable', async () => {
        const mockResponse = {
            packages: {
                'vendor/package': [
                    { version: 'dev-main', version_normalized: 'dev-main', time: '2024-02-01T12:00:00+00:00' },
                    { version: '2.0.0-beta', version_normalized: '2.0.0.0-beta', time: '2024-01-15T12:00:00+00:00' },
                    { version: '1.5.0', version_normalized: '1.5.0.0', time: '2024-01-01T12:00:00+00:00' },
                ],
            },
        };
    ...
    test('falls back to first version if no stable versions', async () => {
        const mockResponse = {
            packages: {
                'vendor/package': [
                    { version: 'dev-main', version_normalized: 'dev-main', time: '2024-02-01T12:00:00+00:00' },
                    { version: 'dev-develop', version_normalized: 'dev-develop', time: '2024-01-15T12:00:00+00:00' },
                ],
            },
        };
    ...
    test('returns first eligible when preferStable is false', async () => {
        const mockResponse = {
            packages: {
                'vendor/package': [
                    { version: '2.0.0-beta', version_normalized: '2.0.0.0-beta', time: '2024-02-01T12:00:00+00:00' },
                    { version: '1.5.0', version_normalized: '1.5.0.0', time: '2024-01-01T12:00:00+00:00' },
                ],
            },
        };
            ...
            return Promise.resolve({
                ...
                json: () =>
                    Promise.resolve({
                        packages: {
                            [packageName]: [
                                { version: '1.0.0', version_normalized: '1.0.0.0', time: '2024-01-01T12:00:00+00:00' },
                            ],
                        },
                    }),
            });
